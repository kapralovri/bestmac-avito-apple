// ESM Serverless Function for Vercel (Node runtime)
export default async function handler(req, res) {
  try {
    ...
    const formatPrice = (n) => new Intl.NumberFormat('ru-RU').format(Number(n)) + ' ₽';
    ...
    <head>
      ...
      <link rel="canonical" href="https://${host}/sell" />
      ...
      <style>
        body{font-family: ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, "Apple Color Emoji","Segoe UI Emoji";margin:0;color:#111;background:#fff}
    ...
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
    return res.status(200).send('<!doctype html><meta charset="utf-8"><title>Sell</title><body>Произошла ошибка. Попробуйте позже.</body>');
  }
}
