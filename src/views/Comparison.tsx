  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        ...
        description="Сравните MacBook Air M1/M2/M3 и Pro 14/16 по процессору, памяти, дисплею и цене б/у. Интерактивная таблица: рейтинги производительности и соотношение цена/качество."
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Сравнение MacBook: Air vs Pro, M1/M2/M3
        </h1>
        ...
        <div className="mt-12 bg-gradient-primary rounded-lg p-8 text-white text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Button asChild size="lg" variant="secondary">
              <Link href="/selection">Подобрать MacBook</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="bg-white text-primary hover:bg-white/90">
              <Link href="/buy">Смотреть в наличии</Link>
            </Button>
          </div>
        </div>
      </main>
