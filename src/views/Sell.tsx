...
const Sell = ({ initialData = null }: SellProps) => {
  ...
  const sellFaqItems = [
    ...
    { question: "Принимаете ли вы сломанные MacBook?", answer: "Да, мы выкупаем MacBook в любом состоянии: залитые водой, с разбитым экраном, не включающиеся, заблокированные (iCloud, EFI). Оценку проблемных устройств проводим по фото за 5 минут — напишите в Telegram." },
