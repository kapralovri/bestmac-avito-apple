...
<main className="flex-grow container mx-auto px-4 py-12">
        ...
        <article className="max-w-4xl mx-auto prose prose-lg">
          ...
          <section className="mb-8 bg-gradient-primary text-white p-6 rounded-lg">
            <h2 className="text-2xl font-semibold mb-3">Продать старый и купить MacBook на M-чипе</h2>
            <p className="mb-4 opacity-90">
              Если апгрейд невыгоден — выкупим ваш старый MacBook и поможем выбрать актуальную модель на Apple Silicon с гарантией.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/sell" className="inline-flex items-center justify-center rounded-lg bg-white text-primary font-semibold px-6 py-3 hover:bg-white/90 transition">
                Продать MacBook
              </Link>
