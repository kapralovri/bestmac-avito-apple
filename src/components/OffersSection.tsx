  ...
  return (
    <section className="apple-section relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/3 left-1/4 w-[700px] h-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,_hsl(260_80%_60%_/_0.25)_0%,_hsl(212_100%_48%_/_0.12)_40%,_transparent_70%)] blur-3xl" />
