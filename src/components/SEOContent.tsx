      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground">
            <p className="mb-4">
              BestMac — ваш надежный партнер в мире техники Apple. Мы специализируемся на продаже и выкупе MacBook, iMac, Mac mini и Mac Studio в Москве. С 2018 года мы помогли тысячам клиентов найти идеальную технику по выгодной цене.
            </p>
            <p className="mb-4">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground">
            ...
            <p className="mb-4">
              Принимаем: MacBook Air, MacBook Pro всех поколений (M1, M2, M3, M4, Intel), iMac 21.5" и 27", Mac Mini, Mac Studio.
            </p>
            <p className="mb-4">
