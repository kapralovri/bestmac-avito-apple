...
const MacbookAirM3Students = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEOHead 
        title="MacBook Air M3 для студентов — купить б/у в Москве | BestMac"
        description="MacBook Air M3 для студентов от 75,000₽. Идеальный ноутбук для учебы: легкий (1.24кг), автономность 18 часов, тихая работа. 16GB RAM, 512GB SSD. Скидка студентам 5%."
        canonical="/buy/macbook-air-m3-students"
        keywords="macbook для студента, macbook air m3 для учебы, macbook для университета, ноутбук для студента"
