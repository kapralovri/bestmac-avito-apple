  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEOHead 
        ...
        description="Самовывоз техники Apple в центре Москвы (ЦАО): ул. Дениса Давыдова 3, м. Киевская, Дорогомилово. Проверка устройства при получении, консультация специалиста, оплата наличными или картой, бесплатная парковка. График: Пн-Пт 10:00-20:00, Сб-Вс 11:00-18:00."
        canonical="/pickup"
