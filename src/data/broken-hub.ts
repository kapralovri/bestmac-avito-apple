...
export const BROKEN_SECTIONS: { id: string; title: string; text: string; link?: { href: string; label: string } }[] = [
  ...
  {
    id: 'blokirovka',
    title: 'Заблокирован iCloud',
    text: 'Если Mac привязан к Apple ID, из которого не получается выйти, выкупаем дешевле исправного — если можете подтвердить, что устройство ваше: чек, коробка или документы. Если Apple ID ваш — выйдите из него перед встречей, и цена будет как за незаблокированный. Краденые не принимаем. Mac с корпоративным профилем MDM не выкупаем: попросите IT-отдел снять его с учёта.',
...
export const BROKEN_FAQ = [
  ...
  },
  {
    ...
    answer: 'С привязкой к iCloud — да, дешевле исправного и только если можете подтвердить, что Mac ваш: чек, коробка или документы. Mac с профилем MDM компании не выкупаем. Если Apple ID ваш, выйдите из него перед встречей, и цена будет выше.',
  },
  {
